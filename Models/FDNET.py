...
class fdnet(nn.Module):
    ...
    def __init__(self,inputLength,fdfilter, xLen):
        ...
        self.conv1 = nn.Conv2d(1, self.fdfilter, (1,3),padding=(0, 0),bias=False) 
        self.conv1L = nn.Conv2d(1, self.fdfilter, (1,2),padding=(0, 0),bias=False ) 
        self.conv1R = nn.Conv2d(1, self.fdfilter, (1,2),padding=(0, 0),bias=False ) 
        
        self.conv2 = nn.Conv2d(self.fdfilter, self.fdfilter, (1,3),padding=(0, 0),bias=False )
        self.conv2L = nn.Conv2d(self.fdfilter, self.fdfilter, (1,2),padding=(0, 0),bias=False )
        self.conv2R = nn.Conv2d(self.fdfilter, self.fdfilter, (1,2),padding=(0, 0),bias=False )
